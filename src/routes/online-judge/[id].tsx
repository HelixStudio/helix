  ...
  return (
    <main class="bg-secondary-800 text-white min-h-screen">
      <div class="ml-auto mr-auto max-w-5xl m-3">
        ...
        <p class="text-xl mt-3 font-bold tracking-tight items-center">Input</p>
        <p>{problem()?.input}</p>
        <p class="text-xl mt-3 font-bold tracking-tight items-center">Output</p>
        <p>{problem()?.output}</p>
        <p class="text-xl mt-3 font-bold tracking-tight items-center">Sample</p>
        ...
        <p class="text-xl mt-3 font-bold tracking-tight items-center">Notes</p>
        <p>{problem()?.notes}</p>
      </div>
    </main>
  );
