...
import { type Post, type User, type Group } from "@prisma/client";

type FullPost = Post & { author: User; group: Group };

const HomePageLarge = (props: { session: Session; posts: FullPost[] }) => {
  return (
    <AppShell>
